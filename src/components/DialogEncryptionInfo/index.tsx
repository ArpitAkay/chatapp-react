...
interface DialogEncryptionInfoProps {
  isDialogBoxOpen: boolean;
  setIsDialogBoxOpen: (value: boolean) => void
}

const Index = (props: DialogEncryptionInfoProps) => {
  return (
    <Dialog open={props.isDialogBoxOpen} maxWidth={"sm"}>
      <DialogContent>
      ...
      <DialogActions>
        <Stack spacing={1} direction={"row"} marginRight={6} marginY={4}>
          <Button
            ...
            onClick={() => props.setIsDialogBoxOpen(false)}
          >
            OK
          </Button>
          <Button
